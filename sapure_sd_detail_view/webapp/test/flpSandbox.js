		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SAPure",
									"targetURL": "#zc503sdgw0002sapuresddetailview-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zc503sdgw0002sapuresddetailview-display": {
								"semanticObject": "zc503sdgw0002sapuresddetailview",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zc503sd.gw0002.sapuresddetailview",
									"url": sap.ui.require.toUrl("zc503sd/gw0002/sapuresddetailview")
								}
							}
						}
					}
