		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SAPure",
									"targetURL": "#zc503sdgw0006sapuresdmainview-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zc503sdgw0006sapuresdmainview-display": {
								"semanticObject": "zc503sdgw0006sapuresdmainview",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zc503sd.gw0006.sapuresdmainview",
									"url": sap.ui.require.toUrl("zc503sd/gw0006/sapuresdmainview")
								}
							}
						}
					}
